<template>
  <div class="control_info">
    <div class="score_header">
      ...
      <div class="title">身体素质能力测试结果</div>
    </div>
    <div class="learnAbility_second">
      <p><span style="color: #34C2F7;font-weight: 700">身体状态：</span>{{this.bodyResult.level}}</p>
      <p>{{this.bodyResult.describe}}</p>
    </div>
  </div>
</template>
