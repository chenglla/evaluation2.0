<template>
  <div class="control_info">
    <div class="score_header">
      ...
      <div class="title">TIMSS-A数学能力测试结果</div>
    </div>
    <div class="learnAbility_second">
      <p>{{this.mathResult.teacherInfluenceContent}}</p>
      <p>{{this.mathResult.hobbyInfluenceContent}}</p>
      <p>{{this.mathResult.othersInfluenceContent}}</p>
    </div>
  </div>
</template>
