...
<!--        <el-carousel-item v-for="item in allPro" :key="item">-->
<!--          <h3 class="small">{{ item }}</h3>-->
<!--        </el-carousel-item>-->
<!--      </el-carousel>-->

      <div class="tag" v-for="item in allPro" :key="item" @click="getcaseByPro(item)">{{item}}</div>
...
<!--      <div class="tag">教育从业</div>-->
    ...
    <div class="push-middle" ref="pushWrapper">
        <div class="push-content" style="padding: 20px 0 5px 0;">
          <div class="push-list" v-for="(caseList,index) in caseLists" :key="index1" @click="toCaseDetail(caseList.caseName,caseList.caseId)">
            <div>
...
<script>
import {findCaseList,getProfessionInfo,getCaseNameByPro} from '@/api/index'
