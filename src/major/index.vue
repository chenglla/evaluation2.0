<template>
  <div class="encyList">
    <div class="ency_header">
      <div class="title">专业百科</div>
    </div>
    <div class="search">
<!--      <search v-model="key" @on-focus="gotoPage('majorSearch')" :placeholder="placeholder"></search>-->
      <input  v-model="key" @focus="gotoPageSearch('majorSearch')" type="text" placeholder='搜索关键词'>
                  ...
                  <el-collapse>
                    <el-collapse-item>
                      ...
                      <ul v-for="(sun, ind) in major.children[sub.middle_index].middle_children" :key="ind">
                        <li>
                          <div class="majorstyle" @click.stop="gotoPage(sun.small_name.majorName,sun.small_name.majorId)">
                            <el-button type="text">{{ sun.small_name.majorName }}</el-button>
                          </div>
                        </li>
                      </ul>
                    </el-collapse-item>
            ...
            <el-collapse>
              <el-collapse-item>
                ...
                <div v-for="(sub1, inde111) in majorzhuan.children" :key="inde111"
                     @click.stop="getMajorList('专科',sub1)">
                  <el-collapse>
                    <el-collapse-item>
                      <template slot="title">
                      ...
                      <ul v-for="(sun1, ind1) in majorzhuan.children[sub1.middle_index].middle_children" :key="ind1">
                        <li>
                          <div class="majorstyle" @click.stop="gotoPage(sun1.small_name.majorName,sun1.small_name.majorId)">
                            <el-button type="text">{{ sun1.small_name.majorName }}</el-button>
                          </div>
                        </li>
                      </ul>
                    </el-collapse-item>
