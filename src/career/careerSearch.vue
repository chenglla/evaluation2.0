<template>
  <div class="encyList">
    ...
    <div class="search">
      <input v-model="key" type="text" @change="getCareer(key)" placeholder='搜索关键词'>
      <i class="iconfont iconsousuo"></i>
    </div>
    <div class="ency_split"></div>
    <div class="ency-middle">
      <div style="padding:20px 0 5px 0;width: 100%">
        <div class="img" v-if="careerList.length == 0">
...
<script>
import {getCareerInfoLike} from '@/api/index'
  ...
  methods: {
    ...
    getCareer(key) {
      ...
      getCareerInfoLike({
        ...
        console.log('majorlist', this.careerList)
      })
    },
    toCareerDetail(sub) {
      console.log('id:', sub)
